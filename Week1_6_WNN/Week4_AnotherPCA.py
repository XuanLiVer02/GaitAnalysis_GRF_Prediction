...
def process_gait_cycles(insole_data, force_data, strikes, offs, pcami=False):
    ...
    for i in range(num_valid):
        ...
        # Interp from insole to combined_times
        ...
        # force: Sample from combined_times
    ...
    if pcami:
        X_insole = raw_insole.reshape(num_points * num_valid, -1)  # [100*N, channels]  ~2600, 1024
        print('raw_insole', raw_insole.shape)
