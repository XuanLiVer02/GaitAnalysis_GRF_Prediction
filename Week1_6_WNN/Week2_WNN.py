...
# Normalize through 0,1, which are batch & time
...
n_hidden = 7  # Number of hidden neurons (adjust as needed)
...
print("GRF x: r = %.4f, RMSE = %.4f, NRMSE = %.4f" % metrics_x)
print("GRF y: r = %.4f, RMSE = %.4f, NRMSE = %.4f" % metrics_y)
print("GRF z: r = %.4f, RMSE = %.4f, NRMSE = %.4f" % metrics_z)
